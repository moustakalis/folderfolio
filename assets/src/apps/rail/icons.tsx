...
/**
 * A smart folder — the folder's outline, dashed (board KZsHhrffzKQYqUjTvdFszK,
 * 13b): the same shape, because it is looked into like a folder, and broken,
 * because nothing is filed into it.
 */
export function SmartFolderIcon(props: IconProps) {
    return (
        <Svg {...props}>
            <path
...
/* A refusal on the notice sheet. The triangle is the shape, not a colour —
   it takes the sheet's accent like the undo arrow, so no new ink is needed. */
